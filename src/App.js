     ...
     <div>
      ...
      <div className="nav center">
          <ul className="nav-group">
            ...
            <li className="nav-item work">photos</li>
            <li className="nav-item glitch">music</li>
          </ul>
      </div>
      ...
      <div className="app">
        ...
        <div className="pg1 center">
            <svg width="70%" height="70%" className="lineDrawing">
              <g className="lines">
            ...
            <Reveal effect="something" wait={500} onReveal={() => this.animate()}>
              <div className="pg3 center">
                ...
                <audio src="/audio/daf.mp3" type="audio/mpeg" controls className="audio">if you can read this, update your browser</audio>
              </div>
            </Reveal>
